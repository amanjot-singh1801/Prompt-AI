        ...
        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/95 p-8 shadow-2xl ring-1 ring-slate-800/60">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-lg border border-slate-700/70 bg-slate-800 px-4 py-3 text-sm mt-6 font-medium text-slate-100 transition-colors hover:bg-slate-700"
            >
